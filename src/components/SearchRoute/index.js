...
class SearchRoute extends Component {
  ...
  renderNoResultView = () => {
    ...
    return (
      <div className="no-result-view-container">
        <img
          src="https://res.cloudinary.com/db3erodfw/image/upload/v1722971972/Not_Found_qfz2oz_ypx7i9.png"
          alt="no movies"
  ...
  renderFailureView = () => (
    <div className="no-result-view-container">
      <img
        src="https://res.cloudinary.com/db3erodfw/image/upload/v1722971822/Failure_l6kgfg_ru2eap.png"
        alt="failure view"
